...
<html lang="en-US">
	...
	<title>Log In &lsaquo; Adnan Portfolio &#8212; WordPress</title>
...
<link rel="stylesheet" id="login-css" href="./wp-admin/css/login.min.css?ver=6.1.1" type="text/css" media="all">
	...
	<script type="text/javascript">document.body.className = document.body.className.replace('no-js','js');</script>
		...
		<form name="loginform" id="loginform" action="http://localhost/adnan/wp-login.php" method="post">
			<p>
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Log In">
									<input type="hidden" name="redirect_to" value="http://localhost/adnan/wp-admin/">
...
if ( typeof wpOnload === 'function' ) { wpOnload() }</script>
				<p id="backtoblog">
			<a href="./index.html">&larr; Go to Adnan Portfolio</a>		</p>
			</div>
...
var _wpUtilSettings = {"ajax":{"url":"\/adnan\/wp-admin\/admin-ajax.php"}};
/*  */</script>
<script type="text/javascript" src="./wp-includes/js/wp-util.min.js?ver=6.1.1" id="wp-util-js"></script>
<script type="text/javascript" id="user-profile-js-extra">/*  */
var userProfileL10n = {"user_id":"0","nonce":"75275e2b4b"};
/*  */</script>
